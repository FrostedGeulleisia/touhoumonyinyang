...
const u8 gText_BirchBoy[] = _("DUMMY"); //Rename those later
const u8 gText_BirchGirl[] = _("DUMMY"); //Rename those later
...
const u8 gText_PokemonJump[] = _("dummy");  //I swear to God please don't play this mode, it sucks
const u8 gText_DodrioBerryPicking[] = _("dummy"); //I swear to God please don't play this mode, it sucks
