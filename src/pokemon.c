...
{
    SPECIES_TO_NATIONAL(CHIBI_SANAE),
    SPECIES_TO_NATIONAL(SANAE),
    SPECIES_TO_NATIONAL(CHIBI_ALICE),
    SPECIES_TO_NATIONAL(ALICE),
    SPECIES_TO_NATIONAL(CHIBI_REISEN),
    ...
    // Megas
    [SPECIES_VENUSAUR_MEGA - 1] = NATIONAL_DEX_CHIBI_ALICE,
    [SPECIES_CHARIZARD_MEGA_X - 1] = NATIONAL_DEX_REISEN,
    [SPECIES_CHARIZARD_MEGA_Y - 1] = NATIONAL_DEX_REISEN,
...
{
    [SPECIES_CHIBI_SANAE - 1]     = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_SANAE - 1]       = ANIM_V_STRETCH,
    [SPECIES_CHIBI_ALICE - 1]      = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_ALICE - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_CHIBI_REISEN - 1]    = ANIM_BACK_AND_LUNGE,
...
u16 GetBattleBGM(void)
{
    if (gBattleTypeFlags & BATTLE_TYPE_KYOGRE_GROUDON)
        ...
        return MUS_VS_TRAINER; //put Youkai Mountain here?
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_MAGMA_ADMIN:
            return MUS_RG_VS_GYM_LEADER; //dummy, originally MUS_VS_AQUA_MAGMA
        case TRAINER_CLASS_LEADER:
            return MUS_RG_VS_GYM_LEADER; //dummy, originally MUS_VS_GYM_LEADER
        case TRAINER_CLASS_CHAMPION:
            return MUS_VS_CHAMPION;
        case TRAINER_CLASS_PKMN_TRAINER_3:
            if (gBattleTypeFlags & BATTLE_TYPE_FRONTIER)
                return MUS_RG_VS_CHAMPION; //dummy, originally MUS_VS_RIVAL
            if (!StringCompare(gTrainers[gTrainerBattleOpponent_A].trainerName, gText_BattleWallyName))
                return MUS_RG_VS_GYM_LEADER; //dummy, originally MUS_VS_TRAINER, consider unique track for Wally?
            return MUS_RG_VS_CHAMPION; //dummy, originally MUS_VS_RIVAL
        ...
        default:
            return MUS_VS_TEST; //dummy, originally MUS_VS_TRAINER
        }
    }
    else
        return MUS_VS_WILD;
