...
#define SOUND_LIST_BGM \
    ...
    X(MUS_DUNGEON_TEST, "MUS-DUNGEON-TEST") \
    ...
    X(MUS_DUNGEON_TEST2, "MUS-DUNGEON-TEST2") \
    X(MUS_TRADING, "MUS-TRADING") \
    ...
    X(MUS_BATTLE_DUMMY01, "MUS-BATTLE-DUMMY01") \
    X(MUS_BATTLE_DUMMY02, "MUS-BATTLE-DUMMY02") \
    X(MUS_BATTLE_DUMMY03, "MUS-BATTLE-DUMMY03") \
    X(MUS_BATTLE_DUMMY04, "MUS-BATTLE-DUMMY04") \
    X(MUS_BATTLE_DUMMY05, "MUS-BATTLE-DUMMY05") \
    X(MUS_BATTLE_DUMMY06, "MUS-BATTLE-DUMMY06") \
    X(MUS_BATTLE_DUMMY07, "MUS-BATTLE-DUMMY07") \
    X(MUS_BATTLE_DUMMY08, "MUS-BATTLE-DUMMY08") \
    X(MUS_BATTLE_DUMMY09, "MUS-BATTLE-DUMMY09") \
    X(MUS_BATTLE_DUMMY10, "MUS-BATTLE-DUMMY10") \
    X(MUS_BATTLE_DUMMY11, "MUS-BATTLE-DUMMY11") \
    X(MUS_BATTLE_DUMMY12, "MUS-BATTLE-DUMMY12") \
    X(MUS_BATTLE_DUMMY13, "MUS-BATTLE-DUMMY13") \
    X(MUS_BATTLE_DUMMY14, "MUS-BATTLE-DUMMY14") \
    X(MUS_BATTLE_DUMMY15, "MUS-BATTLE-DUMMY15") \
    X(MUS_BATTLE_DUMMY16, "MUS-BATTLE-DUMMY16") \
    X(MUS_BATTLE_DUMMY17, "MUS-BATTLE-DUMMY17") \
    X(MUS_BATTLE_DUMMY18, "MUS-BATTLE-DUMMY18") \
    X(MUS_BATTLE_DUMMY19, "MUS-BATTLE-DUMMY19") \
    X(MUS_BATTLE_DUMMY20, "MUS-BATTLE-DUMMY20") \
    X(MUS_FIELD_DUMMY01, "MUS-FIELD-DUMMY01") \
    X(MUS_FIELD_DUMMY02, "MUS-FIELD-DUMMY02") \
    X(MUS_FIELD_DUMMY03, "MUS-FIELD-DUMMY03") \
    X(MUS_FIELD_DUMMY04, "MUS-FIELD-DUMMY04") \
    X(MUS_FIELD_DUMMY05, "MUS-FIELD-DUMMY05") \
    X(MUS_DUNGEON_DUMMY01, "MUS-DUNGEON-DUMMY01") \
    X(MUS_DUNGEON_DUMMY02, "MUS-DUNGEON-DUMMY02") \
    X(MUS_DUNGEON_DUMMY03, "MUS-DUNGEON-DUMMY03") \
    X(MUS_DUNGEON_DUMMY04, "MUS-DUNGEON-DUMMY04") \
    X(MUS_DUNGEON_DUMMY05, "MUS-DUNGEON-DUMMY05") \
