const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHIBI_ALICE]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA}},
    [SPECIES_ALICE]            = {{EVO_LEVEL, 16, SPECIES_CHIBI_REISEN}},
    [SPECIES_CHIBI_REISEN]            = {{EVO_LEVEL, 36, SPECIES_REISEN}},
    [SPECIES_REISEN]             = {{EVO_MEGA_EVOLUTION, ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD_MEGA_X},
