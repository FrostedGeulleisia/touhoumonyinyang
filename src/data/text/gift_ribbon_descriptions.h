...
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("Puppet Battle Cup");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Participation Ribbon");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("Puppet League");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("Advance Cup");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Puppet Tournament");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Participation Ribbon");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("Puppet Event");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("Puppet Festival");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("Puppet Center Tokyo");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("Puppet Center Osaka");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("Puppet Center Nagoya");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("Puppet Center Ny");
...
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("for a loved Puppet.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("Ribbon that shows");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("love for Puppet.");
