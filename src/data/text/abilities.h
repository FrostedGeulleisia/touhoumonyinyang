...
static const u8 sScrappyDescription[] = _("Hits Ghost-type Puppets.");
...
static const u8 sBadDreamsDescription[] = _("Damages sleeping Puppets.");
...
static const u8 sHealerDescription[] = _("Heals partner Puppets.");
