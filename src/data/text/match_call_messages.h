...
const u8 gText_MatchCallAromaLady_Rose_Pokemon[] = _("Fragrant Grass Puppets.");
...
const u8 gText_MatchCallRuinManiac_Dusty_Pokemon[] = _("Craggy Rock Puppets.");
...
const u8 gText_MatchCallTuber_Lola_Pokemon[] = _("Good swimmer Puppets.");
...
const u8 gText_MatchCallTuber_Ricky_Pokemon[] = _("Water Puppets are buddies.");
...
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Pokemon[] = _("We like friendly Puppets.");
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Intro1[] = _("We enjoy Puppets together");
...
const u8 gText_MatchCallCooltrainer_Brooke_Intro2[] = _("Puppet Champion.");
...
const u8 gText_MatchCallLady_Cindy_Intro2[] = _("my Puppets at home.");
...
const u8 gText_MatchCallRichBoy_Winston_Intro2[] = _("custom Puppet bed.");
...
const u8 gText_MatchCallPokeManiac_Steve_Intro2[] = _("Puppets are the best...");
...
const u8 gText_MatchCallKindler_Bernie_Pokemon[] = _("Burn-inducing Puppets.");
...
const u8 gText_MatchCallCamper_Ethan_Pokemon[] = _("I'll raise any Puppet.");
const u8 gText_MatchCallCamper_Ethan_Intro1[] = _("Puppets raised in the wild");
...
const u8 gText_MatchCallOldCouple_JohnAndJay_Intro2[] = _("devotedly raised Puppets.");

const u8 gText_MatchCallBugManiac_Jeffrey_Strategy[] = _("Attack in waves!");
const u8 gText_MatchCallBugManiac_Jeffrey_Pokemon[] = _("Bug Puppets are cool.");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro1[] = _("I go into the forest every");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro2[] = _("day to catch Bug Puppets.");
...
const u8 gText_MatchCallPsychic_Jacki_Pokemon[] = _("Puppets of many mysteries.");
...
const u8 gText_MatchCallGentleman_Walter_Pokemon[] = _("Puppets of distinction.");
...
const u8 gText_MatchCallSchoolKid_Karen_Pokemon[] = _("I love any kind of Puppets!");
...
const u8 gText_MatchCallSchoolKid_Jerry_Pokemon[] = _("Any smart Puppet!");
const u8 gText_MatchCallSchoolKid_Jerry_Intro1[] = _("I want to be a Puppet");
...
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Pokemon[] = _("Puppets that we both like.");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro1[] = _("We're senior and junior");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro2[] = _("students into Puppets!");
...
const u8 gText_MatchCallPokefan_Miguel_Pokemon[] = _("A Puppet raised with love!");
const u8 gText_MatchCallPokefan_Miguel_Intro1[] = _("It's important to build");
const u8 gText_MatchCallPokefan_Miguel_Intro2[] = _("trust with your Puppets.");
...
const u8 gText_MatchCallFisherman_Elliot_Pokemon[] = _("Water Puppets to battle!");
const u8 gText_MatchCallFisherman_Elliot_Intro1[] = _("I'm the world's only guy to");
const u8 gText_MatchCallFisherman_Elliot_Intro2[] = _("catch a huge Puppet!");
...
const u8 gText_MatchCallTriathlete_Maria_Pokemon[] = _("I use a speedy Puppets.");
...
const u8 gText_MatchCallTriathlete_Abigail_Pokemon[] = _("My Puppet is solid.");
...
const u8 gText_MatchCallTriathlete_Dylan_Pokemon[] = _("A fast-running Puppet!");
...
const u8 gText_MatchCallTriathlete_Katelyn_Pokemon[] = _("Water Puppets rule!");
...
const u8 gText_MatchCallTriathlete_Pablo_Pokemon[] = _("Toughened Water Puppets.");
const u8 gText_MatchCallTriathlete_Pablo_Intro1[] = _("Training Puppets is good,");
const u8 gText_MatchCallTriathlete_Pablo_Intro2[] = _("but don't neglect yourself.");

const u8 gText_MatchCallDragonTamer_Nicolas_Strategy[] = _("It's about Puppet power!");
...
const u8 gText_MatchCallBirdKeeper_Robert_Intro1[] = _("My Bird Puppets, deliver my");
...
const u8 gText_MatchCallNinjaBoy_Lao_Pokemon[] = _("Poisonous Puppets.");
...
const u8 gText_MatchCallBattleGirl_Cyndy_Intro1[] = _("If my Puppets lose,");
const u8 gText_MatchCallBattleGirl_Cyndy_Intro2[] = _("I'll carry on the fight!");

const u8 gText_MatchCallParasolLady_Madeline_Strategy[] = _("Go, go, my Puppets!");
...
const u8 gText_MatchCallSwimmer_Jenny_Pokemon[] = _("Cute Water Puppets.");
...
const u8 gText_MatchCallPicnicker_Diana_Pokemon[] = _("I like all Puppets.");
...
const u8 gText_MatchCallTwins_AmyAndLiv_Intro1[] = _("We like the same Puppets,");
...
const u8 gText_MatchCallSailor_Cory_Pokemon[] = _("Water Puppets are my faves!");
...
const u8 gText_MatchCallCollector_Edwin_Strategy[] = _("Protect Puppets from harm.");
const u8 gText_MatchCallCollector_Edwin_Pokemon[] = _("I love rare Puppets.");
const u8 gText_MatchCallCollector_Edwin_Intro1[] = _("I want to collect all the");
const u8 gText_MatchCallCollector_Edwin_Intro2[] = _("world's rare Puppets.");

const u8 gText_MatchCallPkmnBreeder_Lydia_Strategy[] = _("I count on power.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Pokemon[] = _("Puppets are my children.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro1[] = _("It takes knowledge and");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro2[] = _("love to raise Puppets.");
...
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Strategy[] = _("I raise Puppets with care.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Pokemon[] = _("Fun-to-raise Puppets.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro1[] = _("Treat every Puppet you");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro2[] = _("meet with respect.");

const u8 gText_MatchCallPkmnRanger_Catherine_Strategy[] = _("I believe in my Puppets.");
const u8 gText_MatchCallPkmnRanger_Catherine_Pokemon[] = _("I like strong Puppets.");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro1[] = _("I'm training for rescue");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro2[] = _("work with my Puppets.");
...
const u8 gText_MatchCallLass_Haley_Pokemon[] = _("Cute Puppets are my faves!");
const u8 gText_MatchCallLass_Haley_Intro1[] = _("After a battle, I always");
const u8 gText_MatchCallLass_Haley_Intro2[] = _("bathe with my Puppets.");

const u8 gText_MatchCallBugCatcher_James_Strategy[] = _("Lightning-fast attack!");
const u8 gText_MatchCallBugCatcher_James_Pokemon[] = _("Bug Puppets are number 1!");
const u8 gText_MatchCallBugCatcher_James_Intro1[] = _("If you want to catch Bug");
const u8 gText_MatchCallBugCatcher_James_Intro2[] = _("Puppets, wake up early.");

const u8 gText_MatchCallHiker_Trent_Strategy[] = _("I battle with power.");
const u8 gText_MatchCallHiker_Trent_Pokemon[] = _("Hard-bodied Puppets.");
...
const u8 gText_MatchCallHiker_Sawyer_Pokemon[] = _("Hot Puppets!");
const u8 gText_MatchCallHiker_Sawyer_Intro1[] = _("As much as I love Puppets,");
...
const u8 gText_MatchCallYoungCouple_LoisAndHal_Pokemon[] = _("Lovey-dovey Puppets!");
...
const u8 gText_MatchCallPkmnTrainer_Wally_Pokemon[] = _("The 1st Puppet I caught.");
const u8 gText_MatchCallPkmnTrainer_Wally_Intro1[] = _("Puppets and I have grown");
...
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("I prefer rock-hard Puppets.");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("Fighting Puppets rule!");
...
const u8 gText_MatchCallMysticDuo_TateAndLiza_Pokemon[] = _("Always friendly Puppets.");
...
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("Puppets of elegance!");
...
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("Puppets that saved me.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Dignity and respect.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer Puppets of grace.");
